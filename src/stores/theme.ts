...
const defaultPresets: ThemePreset[] = [
  ...
  },
  {
    id: 'dune',
    name: 'Dune',
    description: 'Warm desert-inspired theme with sandy colors',
    type: 'light',
    uiTheme: 'light',
    monacoTheme: 'dune',
    cssVariables: {
      '--background': 'oklch(0.9900 0.0200 85.0000)',
      '--foreground': 'oklch(0.1500 0.0300 30.0000)',
      '--card': 'oklch(0.9900 0.0200 85.0000)',
      '--card-foreground': 'oklch(0.1500 0.0300 30.0000)',
      '--popover': 'oklch(0.9900 0.0200 85.0000)',
      '--popover-foreground': 'oklch(0.1500 0.0300 30.0000)',
      '--primary': 'oklch(0.6000 0.1500 45.0000)',
      '--primary-foreground': 'oklch(0.9800 0.0100 85.0000)',
      '--secondary': 'oklch(0.9500 0.0150 75.0000)',
      '--secondary-foreground': 'oklch(0.2000 0.0300 30.0000)',
      '--muted': 'oklch(0.9500 0.0150 75.0000)',
      '--muted-foreground': 'oklch(0.4500 0.0200 40.0000)',
      '--accent': 'oklch(0.9200 0.0300 65.0000)',
      '--accent-foreground': 'oklch(0.2000 0.0300 30.0000)',
      '--destructive': 'oklch(0.5500 0.2000 15.0000)',
      '--destructive-foreground': 'oklch(0.9800 0.0100 85.0000)',
      '--border': 'oklch(0.8800 0.0250 70.0000)',
      '--input': 'oklch(0.8800 0.0250 70.0000)',
      '--ring': 'oklch(0.6000 0.1500 45.0000)',
      // Scrollbar styling
      '--scrollbar-track': 'oklch(0.9200 0.0300 65.0000)',
      '--scrollbar-thumb': 'oklch(0.8000 0.0400 50.0000)',
      '--scrollbar-thumb-hover': 'oklch(0.7000 0.0500 45.0000)',
    }
  }
];
