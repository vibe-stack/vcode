...
export const PROJECT_UNWATCH_FILE_CHANGES_CHANNEL =
  "project:unwatch-file-changes";
...
export const PROJECT_GET_RECENT_PROJECTS_CHANNEL =
  "project:get-recent-projects";
export const PROJECT_ADD_RECENT_PROJECT_CHANNEL = "project:add-recent-project";
export const PROJECT_REMOVE_RECENT_PROJECT_CHANNEL =
  "project:remove-recent-project";
export const PROJECT_GET_CURRENT_PROJECT_CHANNEL =
  "project:get-current-project";
export const PROJECT_SET_CURRENT_PROJECT_CHANNEL =
  "project:set-current-project";
export const PROJECT_SET_LAST_OPENED_PROJECT_CHANNEL =
  "project:set-last-opened-project";
export const PROJECT_GET_LAST_OPENED_PROJECT_CHANNEL =
  "project:get-last-opened-project";
