...
export function exposeProjectContext() {
  ...
  contextBridge.exposeInMainWorld("projectApi", {
    ...
    openFolder: (folderPath?: string) =>
      ipcRenderer.invoke(PROJECT_OPEN_FOLDER_CHANNEL, folderPath),
    getCurrentProject: () =>
      ipcRenderer.invoke(PROJECT_GET_CURRENT_PROJECT_CHANNEL),
    setCurrentProject: (projectPath: string) =>
      ipcRenderer.invoke(PROJECT_SET_CURRENT_PROJECT_CHANNEL, projectPath),

    // File operations
    openFile: (filePath: string) =>
      ipcRenderer.invoke(PROJECT_OPEN_FILE_CHANNEL, filePath),
    saveFile: (filePath: string, content: string) =>
      ipcRenderer.invoke(PROJECT_SAVE_FILE_CHANNEL, filePath, content),
    createFile: (filePath: string, content?: string) =>
      ipcRenderer.invoke(PROJECT_CREATE_FILE_CHANNEL, filePath, content),
    createFolder: (folderPath: string) =>
      ipcRenderer.invoke(PROJECT_CREATE_FOLDER_CHANNEL, folderPath),
    deleteFile: (filePath: string) =>
      ipcRenderer.invoke(PROJECT_DELETE_FILE_CHANNEL, filePath),
    deleteFolder: (folderPath: string) =>
      ipcRenderer.invoke(PROJECT_DELETE_FOLDER_CHANNEL, folderPath),
    renameFile: (oldPath: string, newPath: string) =>
      ipcRenderer.invoke(PROJECT_RENAME_FILE_CHANNEL, oldPath, newPath),
    renameFolder: (oldPath: string, newPath: string) =>
      ipcRenderer.invoke(PROJECT_RENAME_FOLDER_CHANNEL, oldPath, newPath),
    getFileStats: (filePath: string) =>
      ipcRenderer.invoke(PROJECT_GET_FILE_STATS_CHANNEL, filePath),
    ...
    // File watching
    watchFileChanges: (filePath: string) =>
      ipcRenderer.invoke(PROJECT_WATCH_FILE_CHANGES_CHANNEL, filePath),
    unwatchFileChanges: (filePath: string) =>
      ipcRenderer.invoke(PROJECT_UNWATCH_FILE_CHANGES_CHANNEL, filePath),
    ...
    removeRecentProject: (projectPath: string) =>
      ipcRenderer.invoke(PROJECT_REMOVE_RECENT_PROJECT_CHANNEL, projectPath),

    // Last opened project
    setLastOpenedProject: (projectPath: string) =>
      ipcRenderer.invoke(PROJECT_SET_LAST_OPENED_PROJECT_CHANNEL, projectPath),
    getLastOpenedProject: () =>
      ipcRenderer.invoke(PROJECT_GET_LAST_OPENED_PROJECT_CHANNEL),
    ...
    onFileChanged: (
      ...
      ipcRenderer.on(
        ...
        (_: any, filePath: string, eventType: string) =>
    ...
    onFileCreated: (callback: (filePath: string) => void) => {
      ipcRenderer.on("project:file-created", (_: any, filePath: string) =>
        callback(filePath),
      );
      return () => ipcRenderer.removeAllListeners("project:file-created");
    },
    onFileDeleted: (callback: (filePath: string) => void) => {
      ipcRenderer.on("project:file-deleted", (_: any, filePath: string) =>
        callback(filePath),
      );
    ...
    onFileRenamed: (callback: (oldPath: string, newPath: string) => void) => {
      ipcRenderer.on(
        ...
        (_: any, oldPath: string, newPath: string) =>
