...
export const SettingsPanel: React.FC = () => {
  ...
  // Sync settings from store when panel opens
  useEffect(() => {
  ...
  return (
    <div className="flex h-full max-h-full flex-col border-r">
      {/* Header */}
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="bg-muted/30 border-border/50 w-40 border-r p-2">
