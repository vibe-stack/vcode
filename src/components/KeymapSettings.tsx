...
export const KeymapSettings: React.FC = () => {
  ...
  const { getAllBindings, getBindingsByCategory, searchBindings } =
    useFormattedKeyBindings();
  const { addKeyBinding, removeKeyBinding, updateKeyBinding } =
    useKeyBindingManager();
            ...
            <CardContent>
              <div className="py-8 text-center">
                ...
                <p className="text-muted-foreground text-sm">
                  You can extend the keymap system by adding new commands and
                  bindings
                </p>
              </div>
            </CardContent>
