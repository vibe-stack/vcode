...
!(function (e) {
  ...
  var d = "bippy-0.3.8",
    ...
    L = (e, t) => {
      ...
      for (; null !== r; )
        (null !== r.return && (O(e, r), L(e, r)), (r = r.sibling));
    },
    U = 0,
    W = new WeakMap();
  (() => {
  ...
  function he(e, t, n) {
    ...
    if (
      (arguments.length > 2 &&
        (a.children = arguments.length > 3 ? H.call(arguments, 2) : n),
  ...
  function be(e) {
    ((!e.__d && (e.__d = !0) && B.push(e) && !xe.__r++) ||
      q !== Y.debounceRendering) &&
  ...
  function ye(e, t, n, r, o, i, a, s, l, c, d) {
    ...
    for (
      ...
      null != (h = n.__k[u]) &&
        ...
        h.ref &&
          p.ref != h.ref &&
          (p.ref && Ae(p.ref, null, h), d.push(h.ref, h.__c || m, h)),
        null == f && null != m && (f = m),
        4 & h.__u || p.__k === h.__k
          ? (l = ke(h, l, e))
  ...
  function ke(e, t, n) {
    ...
    if ("function" == typeof e.type) {
      for (r = e.__k, o = 0; r && o < r.length; o++)
        r[o] && ((r[o].__ = e), (t = ke(r[o], t, n)));
      return t;
    }
    e.__e != t &&
      (t && e.type && !n.contains(t) && (t = we(e)),
  ...
  function Se(e, t, n) {
    "-" === t[0]
      ...
      : (e[t] =
          null == n ? "" : "number" != typeof n || ce.test(t) ? n : n + "px");
  }
      ...
      try {
          ...
          if (
            ...
            !u.__e &&
              ((null != u.shouldComponentUpdate &&
                !1 === u.shouldComponentUpdate(w, u.__s, x)) ||
                t.__v === n.__v))
          ) {
            for (
              t.__v !== n.__v &&
        ...
        ((u.state = u.__s),
          ...
          v &&
            ...
            (f = u.getSnapshotBeforeUpdate(h, m)),
          (s = ye(
            e,
            de(
              (S =
                null != d && d.type === fe && null == d.key
                  ? d.props.children
                  : d),
            )
              ? S
  ...
  function Me(e, t, n) {
    ...
    if ((r = e.__k))
      for (o = 0; o < r.length; o++)
        r[o] && Me(r[o], t, n || "function" != typeof e.type);
  ...
  ((ft.prototype.brand = it),
    ...
    ((xt.prototype = new ft()).h = function () {
      ...
      if (((this.g = ht), (this.f |= 1), this.i > 0 && !wt(this)))
        return ((this.f &= -2), !0);
      var e = st;
      try {
        (vt(this), (st = this));
    ...
    (xt.prototype.U = function (e) {
      if (
        void 0 !== this.t &&
        (ft.prototype.U.call(this, e), void 0 === this.t)
      ) {
        this.f &= -33;
  ...
  ((Y.unmount = function (e) {
    ...
    (Kt.prototype.render = function (e, t) {
      ...
      return (
        o && (o.__u &= -33),
        [he(fe, null, t.__a ? null : e.children), o]
      );
    }));
    ...
    yr = Vn(() => {
      ...
      return {
        ...
        classGroups: {
          ...
          "min-h": [
            { "min-h": [sr, t, "min", "max", "fit", "svh", "lvh", "dvh"] },
          ],
          "max-h": [
            { "max-h": [sr, t, "min", "max", "fit", "svh", "lvh", "dvh"] },
          ],
          ...
          delay: [{ delay: A() }],
          animate: [
            { animate: ["none", "spin", "ping", "pulse", "bounce", sr] },
          ],
          ...
          "will-change": [
            { "will-change": ["auto", "scroll", "contents", "transform", sr] },
          ],
          fill: [{ fill: [e, "none"] }],
  ...
  var Dr = new WeakMap(),
          ...
          n =
            t instanceof HTMLElement
              ...
              : (() => {
                  ...
                  ((t.className = "react-scan-flash-overlay"),
                    e.appendChild(t));
                  const n = ((e, t) => {
        ...
        const e = () => {
          ((() => {
            ...
            for (const { update: t } of e)
              (i.length >= 1e3 && i.shift(), i.push(t), a++);
    ...
    qr = (e, t = 0, n = null) =>
      e.reduce((e, r, o) => {
        ...
        return (
          e.push(s),
          r.children?.length && e.push(...qr(r.children, t + 1, i)),
          e
        );
      }, []),
        ...
        Xe(() => {
          ...
          const n = () => {
              ...
              if (r.length > 0) {
                ...
                if (
                  ((i.current = a), z(Mr.value.componentsTree.width), d(o), t)
                ) {
                  t = !1;
          ...
          return () => {
            (r(),
              l(),
              (Xr.value = { query: "", matches: [], currentMatchIndex: -1 }));
          };
        }, []),
        Xe(() => {
          const e = (e) => {
        ...
        bn("div", {
          ...
          children: [
            bn("div", {
              ...
              children: bn("span", {
                children: bn(xn, { name: "icon-ellipsis", size: 18 }),
              }),
            }),
            bn("div", {
              ref: t,
              ...
              children: [
                ...
                bn("div", {
                  ...
                  children: bn("div", {
                    ...
                    onPointerLeave: M,
                    className:
                      "tree h-full overflow-auto will-change-transform",
                    children: bn("div", {
      ...
      return bn("div", {
        ...
        children: [
          ...
          r &&
            bn("div", {
              className:
                "pl-5 border-l border-[#333] mt-0.5 ml-1 flex flex-col gap-0.5",
              children: i.map(([e, t]) =>
                bn(ro, { value: t, path: e, isNegative: n }, e),
              ),
            }),
        ],
      });
          ...
          ? bn("div", {
              ...
              children: [
                ...
                t &&
                  bn("div", {
                    className:
                      "pl-2 border-l border-[#333] mt-0.5 ml-1 flex flex-col gap-0.5",
                    children: o.map((e, t) =>
                      bn(
                        ro,
    ...
    ho = Ht(() => {
      ...
      const a = new Map(
          Array.from(n.contextChanges.entries())
            ...
            .map(([e, t]) => [
              e,
              "partially-initialized" === t.kind ? null : t.changes,
            ]),
        ),
        s =
          "focused" === wl.inspectState.value.kind
                  ...
                  return bn(
                    "div",
                    {
                      children: [
                              ...
                              bn("div", {
                                ...
                                children: [
                                  ...
                                  bn(yo, {
                                    count: s.count,
                                    isFunction:
                                      "function" == typeof s.currentValue,
                        ...
                        bn("div", {
                          className: kr("react-scan-expandable", {
                            "react-scan-expanded": l,
                          }),
                          children: bn("div", {
                            className:
                              "pl-3 text-xs font-mono border-l-1 border-[#333]",
                            children: bn("div", {
      ...
      bn(fe, {
        children: [
          e &&
            bn("div", {
              className:
                "text-[#f87171] bg-[#2a1515] pr-1.5 py-[3px] rounded italic",
              children: e,
            }),
          t &&
            bn("div", {
              className:
                "text-[#4ade80] bg-[#1a2a1a] pr-1.5 py-[3px] rounded italic mt-0.5",
              children: t,
            }),
        ],
      }),
              ...
              children: [
                ...
                bn("button", {
                  ...
                  children: [
                    bn("span", {
                      className:
                        "w-3 flex items-center justify-center opacity-50",
                      children: "-",
                    }),
                    bn("span", {
        ...
        children: [
          bn("div", {
            ...
            children: [
              ...
              bn("span", {
                className:
                  "flex-1 overflow-hidden whitespace-pre-wrap font-mono",
                children: bn(oo, {
                  value: e,
          ...
          "object" == typeof t &&
            ...
            bn("div", {
              className:
                "text-[#666] text-[10px] italic mt-1 flex items-center gap-x-1",
              children: [
                bn(xn, {
    ...
    ko = {
      ...
      cleanup: () => {
        (ko.lastRendered.clear(),
          ko.expandedPaths.clear(),
          Ir.cleanupAll(),
          Qo(),
          Vr());
      },
    ...
    _o = class extends ge {
      ...
      render() {
        return this.state.hasError
          ? bn("div", {
            className: "p-4 bg-red-950/50  backdrop-blur-sm",
              children: [
                bn("div", {
                  className:
      ...
      return (
        Mt(() => {
          ...
          lt(() => {
            ...
            const { parentCompositeFiber: r } = $o(
              n.focusedDomElement,
              n.fiber,
            );
            if (!r)
    ...
    $o = (e, t) => {
      ...
      const a = Ao(n)?.[0];
      return a
        ? { parentCompositeFiber: Mo(a, i) ? a : (a.alternate ?? a) }
        : {};
    },
    Po = (e) => {
      const t = e.memoizedProps ?? {},
  ...
  var Wo = (e, t = !1) => {
    ...
    li = (e) => {
      ...
      for (const e of a)
        (o.changes.add(e.name), o.changesCounts.set(e.name, 1));
  ...
  var Ci = (e, t, n, r, o) => {
    ...
    Ti = (e, t) => {
      const n = {
        isPaused: gt(!vl.options.value.enabled),
            ...
            onCommitFiberRoot(e, t) {
              ...
              ((e, t) => {
                ...
                for (let t = 0, n = r.length; t < n; t++)
                  r[t].config.isValidFiber(e) && o.push(t);
      ...
      const n = Wi.get(e),
        r = ((e) => {
          ...
          for (_(e) ? t.push(e) : e.child && n.push(e.child); n.length; ) {
            const e = n.pop();
            if (!e) break;
            (_(e) ? t.push(e) : e.child && n.push(e.child),
              e.sibling && n.push(e.sibling));
          }
          return t;
        })(e),
  ...
  var Bi,
        ...
        if (e.length > 0) {
          ...
          ji
            ...
            : Di &&
              Ii &&
              a &&
              ($i(Ui, a), Li || (Li = requestAnimationFrame(Qi)));
        }
      }
    ...
    Qi = () => {
      ...
      const e = ((e, t, n, r) => {
        ...
        const s = Array.from(a.entries()).sort(
          ([e, t], [n, r]) => Ri(r.outlines) - Ri(t.outlines),
        );
        for (const [t, n] of s)
          if (a.has(t))
    ...
    oa = (e) => {
      if (
        N(e) &&
        !1 !== vl.options.value.showToolbar &&
        "focused" === wl.inspectState.value.kind
      ) {
        const t = e,
          { selfTime: n } = E(e),
            ...
            (t = requestAnimationFrame(() => {
              ...
              const t = (() => {
                ...
                if (
                  ((n.width = i),
                  (n.height = a),
                  ea && !window.__REACT_SCAN_EXTENSION__)
                )
                  try {
                    ji = new Worker(
                      URL.createObjectURL(
  ...
  ((qi = c()),
    ...
    ((e, t, i, s) => {
      ...
      qi && qi.__esModule
        ? Ji
        : n(Ji, "default", { value: qi, enumerable: !0 }),
      qi,
    ));
  var ma,
    fa = () =>
          ...
          if (o)
            ...
            const o = {
              ...
              timeSinceTabInactive:
                "never-hidden" === Ta ? "never-hidden" : Date.now() - Ta,
    ...
    Fa = (e) => {
      ...
      return {
        componentPath: ((e, t = ya) => {
          ...
          for (; r.return; ) {
            const e = Ca(r.type);
            (e && !Sa(e) && _a(e, t) && e.toLowerCase() !== e && n.push(e),
              (r = r.return));
          }
    ...
    ja = (e) => {
      ...
      return (
        ...
        () => {
          wl.interactionListeningForRenders === t &&
            (wl.interactionListeningForRenders = null);
        }
      );
    },
    Da = (e, t) => {
  ...
  var Ja = () => {
    ...
    rs = ({ className: e = "", size: t = 24 }) =>
      bn("svg", {
        ...
        className: e,
        children: [
          bn("path", { d: "M18 6 6 18" }),
          bn("path", { d: "m6 6 12 12" }),
        ],
      }),
            ...
            case "interaction":
              return [
                ...
                },
                {
                  ...
                  time:
                    Ka(e.timing) - e.timing.renderTime - e.timing.otherJSTime,
                  color: "bg-[#1D3A66]",
        ...
        onClick: async () => {
          n.selectedEvent &&
            (await navigator.clipboard.writeText(
              ms("explanation", n.selectedEvent),
            ),
            t(!0),
            setTimeout(() => t(!1), 1e3));
        },
        ...
        (Ss = requestAnimationFrame(() => {
          ...
          switch (
            ...
            case "transition":
              ...
              ((t.transitionTo.alpha = Math.min(
                t.transitionTo.alpha + 0.03,
                1,
              )),
                Cs());
            case "idle":
  ...
  var Es,
        ...
        p =
          "render" === e.kind
            ? Array.from(e.event.parents).filter(
                (e) =>
                  !o.some((t) => "render" === t.kind && t.event.name === e),
              )
            : [];
      return bn("div", {
        className: "w-full",
        children: [
          bn("div", {
            className: kr([
              "w-full flex items-center relative text-xs min-w-0",
            ]),
            children: [
              bn("button", {
                onMouseLeave: () => {
                ...
                onMouseEnter: async () => {
                  const n = async () => {
                    if (
                      ((t.current.lastCallAt = Date.now()), "render" !== e.kind)
                    ) {
                      const e = Ns.value.current
                        ? Ns.value.current
                        : "transition" === Ns.value.kind
                      ...
                      ga(() => {
                        switch (t) {
                          ...
                          case "fading-out":
                            return void (Ns.value = {
                              kind: "transition",
                              current: Ns.value.current
                                ? { alpha: 0, ...Ns.value.current }
                                : null,
                              transitionTo: {
                                rects: o,
                                alpha: 0,
                    ...
                    const i = e.event.elements.filter(
                ...
                children: [
                  bn("div", {
                    ...
                    children:
                      ...
                      !d &&
                      bn(ts, {
                        className: kr("transition-transform", l && "rotate-90"),
                        size: 16,
                      }),
                  }),
                  bn("div", {
                    style: {
                      minWidth: d ? "fit-content" : r ? "30px" : "60px",
                    },
                        ...
                        children: bn("div", {
                          ...
                          children: [
                            ...
                            bn("div", {
                              ...
                              children: bn("span", {
                                className:
                                  "truncate whitespace-nowrap text-white/70 w-full",
                                children: e,
                              }),
                            }),
                          ],
    ...
    Rs = ({ selectedEvent: e, selectedFiber: t }) => {
      ...
      Be(() => {
        ...
        if (null === t)
          return (
            o(!0),
            void localStorage.setItem("react-scan-tip-is-shown", "true")
          );
        t || o(!1);
      }, []);
      const a =
    ...
    $s = () => {
      ...
      switch (e.route) {
        case "render-visualization":
          return bn(Ps, {
            children: bn(Ms, { selectedEvent: e.selectedEvent }),
          });
        ...
        case "optimize":
          return bn(Ps, {
            children: bn(fs, { selectedEvent: e.selectedEvent }),
          });
      }
      e.route;
    },
    ...
    Ds = ({ item: e, shouldFlash: t }) => {
      const [n, r] = Ve(!1),
        ...
        i = (({ flashingItemsCount: e, totalEvents: t }) => {
          ...
          flashingItemsCount: e.events.reduce(
            (e, n) => (t(n.id) ? e + 1 : e),
            0,
          ),
          ...
          return bn("button", {
            ...
            children: [
              bn("div", {
                ...
                children: [
                  bn(ds, { size: 14, className: "mr-1.5" }),
                  " FPS Drop",
                ],
              }),
              bn("div", {
      ...
      return bn("div", {
        ...
        children: [
          ...
          bn("div", {
            ...
            children: [
              bn("div", {
                className: kr(["h-full min-w-[200px]"]),
                children: bn(Us, {}),
              }),
              bn("div", {
    ...
    Bs = jr(() => {
      ...
      const r = wl.inspectState,
        ...
        c = Ge((e) => {
          if ((e.preventDefault(), e.stopPropagation(), !vl.instrumentation))
            return;
                ...
                onClick: () => {
                  switch (
                    ...
                    case "inspector": {
                      ...
                      return (
                        s([...t.values()]),
                        void (Rr.value = { view: "notifications" })
                      );
                    }
                    case "notifications":
    ...
    rl = () => {
      const e = qe(null),
        ...
        g = _r((r) => {
          if ("inspecting" !== wl.inspectState.peek().kind || !t.current)
            return;
                  ...
                  (o.current !== e.focusedDomElement &&
                    ...
                    (l = wl.lastReportTime.subscribe(() => {
                      if (i.current && n.current) {
                        const { parentCompositeFiber: t } = Ro(
                          e.focusedDomElement,
                        );
    ...
    al = (e, t, n) => {
      ...
      return (
        a &&
          ((c = r
            ? Math.min(-24, Math.max(c, -p))
            : Math.max(u, Math.min(c, p))),
              ...
              d ||
                ...
                (d = requestAnimationFrame(() => {
                  const { newSize: n, newPosition: o } = ((e, t, n, r, o) => {
                    ...
                    return (
                      (d = i
                        ? Math.min(-24, Math.max(d, -p))
                        : Math.max(24, Math.min(d, p))),
                      (u = Math.max(24, Math.min(u, h))),
                      {
                        newSize: { width: l, height: c },
                        newPosition: { x: d, y: u },
                      }
                    );
                  })(
    ...
    dl = () => {
      const e = qe(null),
                ...
                c =
                  "horizontal" === t
                    ? {
                        ...
                        y: window.innerHeight - n.height - yn,
                      }
                    : {
                        x: window.innerWidth - n.width - yn,
          ...
          const g = (e) => {
              p ||
                ...
                (p = requestAnimationFrame(() => {
                  ...
                  let N =
                    k * o.height + _ * o.width - k * _ >
                    0.35 * (o.width * o.height);
                  ...
                  if (N) {
                    ...
                    ((s =
                      ...
                      (Mr.value = {
                        ...
                        lastDimensions: {
                          ...o,
                          position: al(a, o.width, o.height),
                        },
                      }));
            ...
            w = () => {
              ...
              const v = ((e, t, n, r, o = 100) => {
                ...
                a,
                s,
                "focused" === wl.inspectState.value.kind ? 80 : 40,
              );
        ...
        s = Ge((t) => {
          ...
          const c = (t) => {
              ...
              if (
                ("horizontal" === o
                  ? ((r.endsWith("left") && u > 50) ||
                      (r.endsWith("right") && u < -50)) &&
                    (h = !0)
                ...
                if (
                  ...
                  requestAnimationFrame(() => {
                    if (e.current) {
                      ...
                      ((l = Math.max(
                        yn,
                        Math.min(l, window.innerWidth - a - yn),
                      )),
                        (c = Math.max(
                          yn,
                          Math.min(c, window.innerHeight - s - yn),
                        )),
                        (Mr.value = {
                          ...Mr.value,
                          dimensions: {
      ...
      Xe(() => {
        ...
        (Cr(zn),
          ...
          (e.current.style.maxWidth = "calc(100% - 48px)"),
          (e.current.style.maxHeight = "calc(100% - 48px)"),
          i(),
          "focused" === wl.inspectState.value.kind ||
            $r.value ||
            o.current ||
  ...
  ae &&
    window.__REACT_SCAN_EXTENSION__ &&
    (window.__REACT_SCAN_VERSION__ = vl.version);
  var xl,
    yl = (e) => {
      const t = [],
        n = {};
    ...
    Cl = () => {
      try {
        if (!ae) return;
        if (
          !vl.runInAllEnvironments &&
          Sl() &&
          !vl.options.value.dangerouslyForceRunInProduction
        )
          return;
        ...
        if (e) {
          ...
          Object.keys(t).length > 0 &&
            (vl.options.value = { ...vl.options.value, ...t });
        }
        const t = _l();
        (sa(() => {
    ...
    Tl = (e) => {
      ...
      ((e) => {
        ...
        ((t.id = "react-scan-toolbar-root"),
          ...
          Re(
            bn(hl, {
              children: bn(fe, { children: [bn(pl, {}), bn(dl, {})] }),
            }),
            t,
          ));
    ...
    El = (e = {}) => {
      kl(e);
      (!wl.isInIframe.value ||
        vl.options.value.allowInIframe ||
        vl.runInAllEnvironments) &&
  ...
  */ (e.ReactScanInternals = vl),
    ...
    (e.getReport = (e) => {
      if (e) {
        for (const t of Array.from(wl.legacyReportData.values()))
