...
import { Edit2, Paperclip, User } from 'lucide-react';
...
export const TaskCard: React.FC<TaskCardProps> = ({ task, onEdit, onClick }) => {
  ...
  return (
    <div
      className="bg-accent/10 border rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow cursor-pointer group"
