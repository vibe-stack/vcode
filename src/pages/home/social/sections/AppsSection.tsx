...
function AppCard({ app, featured = false }: AppCardProps) {
  ...
  return (
    <Link to={app.route}>
      <Card className={`p-5 cursor-pointer hover:shadow-lg transition-all duration-200 border-border/50 group ${
        featured ? 'bg-gradient-to-br from-background to-accent/5' : ''
      }`}>
