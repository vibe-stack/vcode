...
const accentGradients: Record<string, {
  base: string;
  hover: string;
}> = {
  blue: {
...
export function getActiveAccentClasses(accentColor: string, useGradient: boolean = true) {
  if (!useGradient) {
    // Solid color classes
...
export function getAccentGlowStyle(accentColor: string, useGradient: boolean = true) {
