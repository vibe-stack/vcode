 ...
 */
export const GlobalKeymapProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
 ...
 */
export const EditorKeymapProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
  ...
  return (
    <div ref={editorRef} className="editor-keymap-provider h-full w-full">
      {children}
    </div>
  );
};
